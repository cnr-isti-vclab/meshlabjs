...
Each layer maintains a collection of overlays created by the activation of the rendering plugins and a map of values of overlays parameters corresponding to each option that can be changed from the gui widgets.
